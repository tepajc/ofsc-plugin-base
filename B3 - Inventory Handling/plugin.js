...
function openMessage(data) {
  ...
  var resource_table = new Tabulator("#resources-table", {
    ...
    columns:[
        {title:"ID", field:"resourceId", width:100, editor:false},
        {title:"Name", field:"name", width:100, editor:false},
        {title:"Parent", field:"parentResourceId", editor:false},
        {title:"Type", field:"resourceType", headerFilter:true}
    ],
  });
  ...
  var inventory_table = new Tabulator("#inventory-table", {
    ...
    columns:[
      {formatter:"rowSelection", field: "is_selected", titleFormatter:"rowSelection", hozAlign:"center", headerSort:false, cellClick:function(e, cell){
        cell.getRow().toggleSelect();
      }},
      {title:"Serial#", field:"invsn", width:100, headerFilter:true, editor:false},
      {title:"Type", field:"Item Type", width:100, headerFilter:true, editor:false},
      {title:"Assigned to", field:"assigned", headerFilter:true, editor:false},
      {title:"Changed", field:"changeApplied", headerFilter:true, formatter:"tick"}
    ],
  });
