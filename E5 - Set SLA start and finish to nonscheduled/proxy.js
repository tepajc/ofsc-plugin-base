class OFSCProxy {
    ...
    getNonscheduledActivities(root, offset=0, limit=1000, fields, query) {
        var myHeaders = new Headers();
        var theURL = new URL('/rest/ofscCore/v1/activities',this.baseURL);
        theURL.searchParams.append("resources", root);
        theURL.searchParams.append("includeNonScheduled", "true");
    ...
    getActivityBookingOptions(activity , additionalParameters , areas, dates) {
        var myHeaders = new Headers();
        myHeaders.append("Authorization", this.authorization);
        ...
        if ("TIMESLOT_Selected" in additionalParameters && additionalParameters.TIMESLOT_Selected != ""){
            theURL.searchParams.append("TIMESLOT_Selected", additionalParameters.TIMESLOT_Selected);
        }
